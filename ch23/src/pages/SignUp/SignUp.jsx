...
import { signupButton } from "../../components/PasswordInput/styles";
    ...
    return (
        <div css={s.layout}>
            ...
            <div>
                ...
                <div>
                    <TextInput title={"아이디 "} name={"fullName"} />
                </div>
                <div>
                ...
                <div css={s.agree}>
                    <label>
                        <input type="checkbox" />
                        <span css={s.coloring}>이용약관</span> 및 <span css={s.coloring} >개인정보처리방침</span>에 동의합니다.
                    </label>
                </div>
                <div>
